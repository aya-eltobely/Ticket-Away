...
function displayTicketInfo() {
  // if(validateInputs() == true & validatePhone()== true & validateName()== true & validateFromTicket()== true & validateToTicket()== true & validateDate()== true & validateTickets()== true & validatePay()== true & validateSameTicket()== true) 
  {
    ...
    } // else if(fromTicketInput !="" || toTicketInput != ""){
    //     for(var i=0;i<staions.length;i++){
    //             if(staions[i] != fromTicketInput.value){
    ...
    // }
        ...
        add(); // console.log(userInformationss.length);
      }
  }
}
...
AlertFrom.classList.add("invisible"); // fromTicketInput.addEventListener("keyup", validateFromTicket);
...
AlertTo.classList.add("invisible"); // toTicketInput.addEventListener("keyup", validateToTicket);
...
Alertpay.classList.add("invisible");
payInput.addEventListener("keyup", validatePay); // function validateInvalidStation(){
//  for(var i=0;i<staions.length;i++){
//     if(staions[i] != fromTicketInput.value){
//         alert("enter valid station");
//         return false;
