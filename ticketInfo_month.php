            ...
            <div>
              <h4 class="text-info mb-4"><img class="img-fluid ticketImg" src="images/ttt.png" alt="ticket">passenger Details</h4>
                    <div class="info contain ml-5">
                        <div class="info">
                        <p><?php echo $_SESSION['name2']; ?></p>
                        <p>ID: <?php echo $_SESSION['id2']; ?></p>
                        <p>Phone: <?php echo $_SESSION['phone2']; ?></p>
                        </div>
                        <br>
                        <br>
                        <div class="tick">
                        <p class="font-weight-bold text-secondary pb-2"><?php echo $_SESSION['date2']; ?></p>
                        <div class="row px-3">
                            <p class="mr-5">From: <?php echo $_SESSION['st12']; ?></p>
                            <p>To: <?php echo $_SESSION['st22']; ?></p>
                        </div>
                        <p><i class="fa fa-user" aria-hidden="true"></i> <?php echo $_SESSION['tickets2']; ?> passengers</p>
          ...
          <button type="button" class="btn btn-outline-primary d-none" id="payBtn" onclick="pppp()">Get Your Payment Information</button>
            <div>
              <h4 class="text-info"><img class="img-fluid ticketImg" src="images/pa2.jpg" alt="ticket">Card Details</h4>
                    ...
                    <p><?php echo $_SESSION['nameP2']; ?></p>
                    <br>
                    <div class="cardInfo">
                    <p>Card Number: <?php echo $_SESSION['cardnum2']; ?></p>
                    <p>MM/YY: <?php echo $_SESSION['expiryDate2']; ?></p>
                    <p>CVC: <?php echo $_SESSION['cvc2']; ?></p>
                    </div>
                    <p class="text-success">This Trip Is Operated By: Ticketaway</p>
                    <br>
                    <br>
